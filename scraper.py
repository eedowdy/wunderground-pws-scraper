...
def render_page(url):
    driver = webdriver.Chrome("C:\\Users\Erin Dowdy\Downloads\chromedriver_win32\chromedriver")
    driver.get(url)
    time.sleep(3)
...
def scraper(date, station_path, outpath):
    stations = []
...
stations = r'C:\\Users\\Erin Dowdy\\Documents\\hackathon\\stations.txt'
date = '2022-6-14'
df_output = scraper(date, stations, r'C:\\Users\\Erin Dowdy\\Documents\\hackathon\\results.csv')
